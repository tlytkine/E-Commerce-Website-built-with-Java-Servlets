...
public class Checkout extends HttpServlet {
	...
	out.println ("<form action=\"http://unix.seas.gwu.edu:40223/servlets/a4servlets/Checkout\" method=\"post\">");
	...
	out.println("</form");
	if(total==0){
		out.println("Please login and add items to your cart to check out.");
	}
	else {
		out.println("<b>Payment Information:</b> This ones on us :)<br>");
		out.println("Please review your order before submitting it.<br>");
		out.println("<a href=\"http://unix.seas.gwu.edu:40223/servlets/a4servlets/Submit\">Submit order.</a><br>");
